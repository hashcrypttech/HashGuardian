    ...
    <div class="wd-card">
        @if($entries->isEmpty())
            <div class="wd-empty">
                ...
                <div class="wd-empty-text">There are no queries to display.</div>
            </div>
        @else
            <table class="wd-table">
                ...
                <tbody>
                    @foreach($entries as $entry)
                        ...
                        <tr>
                            <td>
                                <code class="wd-code-inline">{{ \Illuminate\Support\Str::limit($c['sql'] ?? 'N/A', 100) }}</code>
                            </td>
                            <td>{{ $c['connection'] ?? 'N/A' }}</td>
                            <td>
